...
const WalletSelectView = ({ onClose, onSelectWallet }) => {
    return (
        <div
            className="relative w-full md:w-[95%] max-w-[420px] h-[550px] md:h-auto bg-neutral-900 border border-gray-700 rounded-t-3xl md:rounded-3xl p-6 shadow-2xl flex flex-col overflow-hidden"
